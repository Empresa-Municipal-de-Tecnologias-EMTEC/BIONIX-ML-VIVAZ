...
public class MainForm : Form
{
    ...
    private PointF? normPt1;
    private PointF? normPt2;
    ...
    private void OnPictureMove(object? sender, MouseEventArgs e)
    {
        ...
        if (clickPhase == 1) pictureBox.Invalidate();
    }
    ...
    private static void DrawBox(Graphics g, Rectangle imgRect, PointF n1, PointF n2, Color color, bool dashed)
    {
